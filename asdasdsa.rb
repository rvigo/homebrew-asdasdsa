...
class Asdasdsa < Formula
  ...
  url "https://github.com/rvigo/asdasdsa/archive/refs/tags/v1.2.2.tar.gz"
  sha256 "5b11111a325bda010fbff8c9f5697f153629c3d3fd4ad207fbcad1e6765886ec"
  license "MIT"
  head "https://github.com/rvigo/asdasdsa.git", branch: "main"

  bottle do
    root_url "https://github.com/rvigo/homebrew-asdasdsa/releases/download/asdasdsa-1.2.2"
